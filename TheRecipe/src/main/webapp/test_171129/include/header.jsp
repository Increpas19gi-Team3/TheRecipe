...
<body>
	<div class="header">
		<div class="logo"><a href="home.html">The Recipe</a></div>
		<div class="nav_wrap">
			<div class="nav_inner">
				<div class="nav_left">
					<ul>
						<li class="dropdown_wrap">
							<a href="foodtList.jsp" class="dropdown_select">분류</a>
							<ul class="dropdown_itemWrap">
								<li><a href="foodtList.jsp">한식</a></li>
								<li><a href="foodtList.jsp">중식</a></li>
								<li><a href="foodtList.jsp">양식</a></li>
								<li><a href="foodtList.jsp">간식</a></li>
								<li><a href="foodtList.jsp">야식</a></li>
							</ul>
						</li>
						<li class="dropdown_wrap">
