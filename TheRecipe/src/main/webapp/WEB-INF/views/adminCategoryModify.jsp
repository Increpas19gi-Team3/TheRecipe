                    ...
                    <form action="modifyCategory.do" method="post" onsubmit="return check();">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" name="fc_ctgname" id="fc_ctgname" type="text" aria-describedby="nameHelp" placeholder="카테고리 이름">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="">카테고리 사용여부</label><br />
                                <input type="radio" name="fc_isblock" id="fc_isblock_0" value="0" checked="checked"><label for="fc_isblock_0">사용</label> &nbsp;
