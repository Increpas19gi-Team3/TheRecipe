	...
	<div class="header">
		...
		<div class="nav_wrap">
			<div class="nav_inner">
				<div class="nav_left">
					<ul>
						<li class="dropdown_wrap"><a href="totalFoodList.do?large=1"
							class="dropdown_select">분류</a>
						...
						<li class="dropdown_wrap"><a href="totalFoodList.do?large=2"
							class="dropdown_select">유명 TV 레시피</a>
							<ul class="dropdown_itemWrap">
								<li><a href="localKindList.do?large=2&medium=1">올리브TV</a></li>
								<li><a href="localKindList.do?large=2&medium=2">집밥백선생</a></li>
								<li><a href="localKindList.do?large=2&medium=3">냉장고를
										부탁해</a></li>
