...
<div class="container boardNotice board">
	<div class="row">
		...
		<div class="right_contnet">
			...
			<form:form commandName="noticeUpdateCom" action="NoticeUpdate.do" method="post" enctype="multipart/form-data">
			
			<input type="hidden" name="e_evtcode" value="${e_evtcode}">
			
				<fieldset>
					<label for="">제목</label> 
					<input type="text" id="e_nttilte" name="e_nttilte" required="내용을 입력하세요">
				</fieldset>
