...
//
///**
// * 후기 게시판 리스트 컨트롤러 기능 : 검색(제목), 페이징, 정렬(기간) 1. 단순 리스트 출력 2. 상세보기로 들어가기 위한 연결 링크
// * 
// * @author 손대성
// *
// */
...
//		ReviewVO ReviewList = reviewListService.getReviewVOList(pageCutCount, requestPageNumber, whereColumn, word,
//				sortColumn, orderby);
...
//
//	/**
//	 * 이벤트 리스트를 출력하기 위한 컨트롤러 "EventList.do"로 요청 받음
//	 * 'GUBUN'은 여기서 필요가 없지만 이 코드를 지웠을 경우에 
//	 * 'EventListDTO(이벤트처리가 아닌 페이징 처리에 관한'DTO'임)'도 건들여야 함 
//	 * 그렇게 되면 'review'에 관한 'EventListDTO'를 따로 만들어야 하기 때문에 그냥 가져다 씀
//	 * @param model
//	 * @param req 요청
//	 * @param resp 응답
...
//
//		// 명칭은 'EventListDTO'이지만, 공지사항도 처리함
//		EventListDTO noticeList = ReviewListService.getReviewVOList(pageCutCount, requestPageNumber, whereColumn, word, sortColumn, orderby, GUBUN);
