...
public class AdminOrderVO {
	...
	private String sub_name; /*배송상태별 이름*/
	...
	public String toString() {
		return "AdminOrderVO [o_orderid=" + o_orderid + ", d_status=" + d_status + ", m_userid=" + m_userid
				+ ", f_fdcode=" + f_fdcode + ", o_buyprice=" + o_buyprice + ", o_amount=" + o_amount + ", o_orderdate="
				+ o_orderdate + ", o_reciever=" + o_reciever + ", o_dvypost=" + o_dvypost + ", o_dvyaddr=" + o_dvyaddr
				+ ", ms_code=" + ms_code + ", sub_name=" + sub_name + "]";
	}
