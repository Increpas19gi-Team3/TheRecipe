 ...
 *
 */
public class FoodJoinFoodcodeVO {
	...
	public String toString() {
		return "FoodJoinFoodcodeVO [f_fdcode=" + f_fdcode + ", e_evtcode=" + e_evtcode + ", f_foodname=" + f_foodname
				...
				+ f_isblock + ", fc_ctgname=" + fc_ctgname + ", fc_isblock=" + fc_isblock + "]";
	}
