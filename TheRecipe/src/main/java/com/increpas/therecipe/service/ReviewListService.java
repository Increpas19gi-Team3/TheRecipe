...
//	 * @return
//	 */
//	public EventListDTO getReviewVOList(int pageCutCount, int requestPageNumber, String whereColumn, String word,
...
//		// 4....
//		int totalBoardVOCount = reviewDAO.selectReviewCount(eventListDTO);
//
...
//		eventListDTO.setGUBUN(GUBUN);
//
//		return eventNoticeDAO.selectEventSetList(eventListDTO);
//	}
//
//	/**
//	 * 전체 페이지 갯수 계산
